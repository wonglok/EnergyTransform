    ...
    let mat = this.mat = new ShaderMaterial({
      ...
      vertexShader: `
        ...
        void main()	{
          ...
          newPos += colorA.r * normal.xyz * 1.5;
      ...
      fragmentShader: `
        ...
        void main (void) {
          vec4 colorA = texture2D(audioTexture, vec2(vUv.x, vUv.y));
          gl_FragColor = vec4(vec3(colorA.r * 1.3, colorA.r, colorA.r), (colorA.r + 0.1) * 0.5);
        }
      `
    })
    setInterval(() => {
      mat.uniforms.time.value = window.performance.now() / 1000
    }, 1000 / 60)
    this.material = mat
    this.setupAudio()
